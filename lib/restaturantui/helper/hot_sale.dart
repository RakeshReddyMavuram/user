...
class HotSale extends StatefulWidget {
  ...
  HotSale(this.currencySymbol,this.popularItem,this.onVerificationDone,);
...
class _HotSaleState extends State<HotSale> {
                          ...
                          Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  //   },
                                  //   child: Icon(
                                  //     // (item.variant[index].isFaviourite == 0)
                                          ...
                                          db.getRestProdQty('${item.variant_id}')
                                            ...
                                            db.getAddOnList('${item.variant_id}')
                                              ...
                                              print(
                                                ...
                                                // productDescriptionModalBottomSheet(context, height,item,widget.currencySymbol).then((value){
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      InkWell(
                                        onTap: () {
                                          // productDescriptionModalBottomSheet(context, height);
                                        },
                                        child: Container(
                                          height: 20.0,
                                          width: 20.0,
  ...
  void setFaviouriteResturant(
      PopularItem item, BuildContext context, index, product_id) async {
    DatabaseHelper db = DatabaseHelper.instance;
    var vae = {
    ...
    db.insertFaviProduct(vae).then((value) {
      print('$value');
      setState(() {
        item.variant[index].isFaviourite = 1;
      });
