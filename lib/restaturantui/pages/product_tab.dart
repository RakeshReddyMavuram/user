        ...
        if (jsonData['status'] == "1") {
          ...
          if (tagObjs != null && tagObjs.length > 0) {
            setState(() {
              ...
              // for(CategoryResturant resturant in categoryList2){
              //   int count = categoryList.where((element) => element.resturant_cat_id == resturant.resturant_cat_id).toList().length;
              //   print('${resturant.resturant_cat_id} -- ${resturant.cat_name} -- ${count}');
              // }
              // List<CategoryResturant>  categoryListNew2 = [];
              // categoryListNew2 = categoryList.where((element) => element.resturant_cat_id == categoryList2[0])
            });
          } else {
            setState(() {
              isFetch = false;
    ...
    return ListView(
      ...
      children: <Widget>[
        /* Popular Items Start
         ...
         PopularItemList(widget.item,widget.currencySymbol,(){widget.onVerificationDone();
         }),*/
