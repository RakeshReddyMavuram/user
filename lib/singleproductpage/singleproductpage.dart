                  ...
                  IconButton(
                      ...
                      onPressed: (){
                        if(isCartCount){
                          ...
                          Toast.show('No Value in the cart!', context,duration: Toast.LENGTH_SHORT);
                        }
                      }
                  ),
                  Positioned(
...
//                CachedNetworkImage(
//                  fit: BoxFit.cover,
//                  imageUrl: imageBaseUrl + widget.productWithVarient.products_image,
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: 17, color: (currentIndex==0)?kWhiteColor:black_color, fontWeight: FontWeight.w500),
                    ),
                  ),
                ),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 17, color: (currentIndex==1)?kWhiteColor:black_color, fontWeight: FontWeight.w500),
                    ),
                  ),
                )
              ],
          ...
          Expanded(
              ...
              child: Container(
                ...
                child: IndexedStack(
                  index: currentIndex,
                  children: [
                    ProductDescription(widget.productWithVarient.data[0].description),
                    (widget.productVarintList.length>0)?ListView.builder(
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    (widget.productVarintList != null &&
                                        widget.productVarintList.length >
                                            0)
                                        ?
//                          CachedNetworkImage(
//                          height: 93.3,
                              ...
                              Positioned(
                                  ...
                                  child: widget.productVarintList[index].add_qnty ==
                                    ...
                                    child: FlatButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          var stock = int.parse('${widget.productVarintList[index].stock}');
                                          if (stock >
                                            ...
                                            addOrMinusProduct(
                                                ...
                                                widget.productVarintList[
                                                index].unit,
                                                double.parse('${widget.productVarintList[
                                                index]
                                                    .price}'),
                                                int.parse('${widget.productVarintList[
                                                index]
                                                    .quantity}'),
                                                widget.productVarintList[
                                                index]
...
//            'Description',
//            style: TextStyle(
//                fontSize: 17, color: black_color, fontWeight: FontWeight.w500),
//          ),
//        ),
//      ),
      body: Container(
