...
class SubCategoryList{
  ...
  SubCategoryList(this.subcat_id, this.category_id, this.subcat_name,
      this.subcat_image, this.created_at, this.updated_at,this.type);

  factory SubCategoryList.fromJson(dynamic json){
    return SubCategoryList(json['subcat_id'], json['category_id'], json['subcat_name'], json['subcat_image'], json['created_at'], json['updated_at'],'SubCat');
  }

  @override
  String toString() {
    return 'SubCategoryList{subcat_id: $subcat_id, category_id: $category_id, subcat_name: $subcat_name, subcat_image: $subcat_image, created_at: $created_at, updated_at: $updated_at, type: $type}';
  }
}
...
class VarientList {
  ...
  factory VarientList.fromJson(dynamic json){
    return VarientList(json['varient_id'], json['product_id'], json['quantity'], json['unit'], json['strick_price'], json['price'], json['description'], json['varient_image'], json['vendor_id'], json['stock'],json['subcat_id'], json['product_name'], json['product_image'], json['created_at'], json['updated_at'],0);
  }

  @override
  String toString() {
    return 'VarientList{varient_id: $varient_id, product_id: $product_id, quantity: $quantity, unit: $unit, strick_price: $strick_price, price: $price, description: $description, varient_image: $varient_image, vendor_id: $vendor_id, stock: $stock, selected: $selected, add_qnty: $add_qnty, subcat_id: $subcat_id, product_name: $product_name, product_image: $product_image, created_at: $created_at, updated_at: $updated_at}';
  }
}