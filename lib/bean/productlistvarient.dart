...
class ProductWithVarient{
  ...
  ProductWithVarient(
      this.product_id, this.product_name, this.products_image, this.add_qnty, [this.data]);
  ...
  factory ProductWithVarient.fromJson(dynamic json){
    ...
    return ProductWithVarient(json['product_id'], json['product_name'], json['products_image'], 0,_tags);
    // if(tagObjsJson.length>0){
    //
    //
    // }else{
    //   return ProductWithVarient(json['product_id'], json['product_name'], json['products_image'],0,[]);
    // }
  }
