...
class PaymentPage extends StatefulWidget {
  ...
  PaymentPage(this.vendor_ids, this.order_id, this.cart_id, this.totalAmount, this.tagObjs,this.orderArray);
...
class PaymentPageState extends State<PaymentPage> {
  ...
  void getVendorPayment() async {
    ...
    var url = paymentvia;
    var client = http.Client();
    client.post(url, body: {'vendor_id': '${widget.vendor_ids}'}).then((value) {
  ...
  void hitNavigator(cart_id, payment_method, payment_status, order_id,
    ...
    http.post(url, body: {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(payment_method, payment_status, cart_id, rem_price,currency,"1");
      }));
    }).catchError((e) {
      setState(() {
        showDialogBox = false;
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(payment_method, payment_status, order_id, rem_price,currency,"1");
      }));
    });
  }
