    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 10,),
            Padding(padding: EdgeInsets.symmetric(horizontal: 10),child: Text('Notification',style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //   inactiveThumbColor: kMainTextColor,
  ...
  void hitService(BuildContext context, ProgressDialog pr) async {
    ...
    await http.post(url,
        body: {'user_id': '${userId}',
          ...
          'email': '${(_switchValueEmail)?1:0}'}).then((response){
      if (response.statusCode == 200) {
        ...
        if (jsonData['status'] == "1") {
         ...
         pr.hide();
         Toast.show('Settings Updated', context,duration: Toast.LENGTH_SHORT,gravity: Toast.BOTTOM);
        }else{
          Toast.show('Settings Updated', context,duration: Toast.LENGTH_SHORT,gravity: Toast.BOTTOM);
          pr.hide();
        }
