...
//  RewardValue rewardValue = RewardValue.fromJson(jsonData['data']);
        setState(() {
...
//    rewardValues = rewardValue.value;
        });
//  print('${rewardValue.toString()}');
      }
      setState(() {
        isFetchStore = false;
      });
...
//                    fontWeight: FontWeight.bold,
//                    color: kWhiteColor),),
                  Text('Reward Point', style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                      color: kWhiteColor),),
                ],
                        ...
                        Row(
                          children: [
                            Text('${index + 1}', style: TextStyle(
                                ...
                                color: kMainTextColor),),
                            SizedBox(width: 35,),
                            Text('#${history[index].cart_id}', style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: kMainTextColor),),
//                     SizedBox(width: 10,),
...
//                          ),
                        ...
                        Text(
                          '${history[index].reward_points}', style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: kMainTextColor),),
                      ],
    ...
    client.post(url, body: {
      ...
      if (value.statusCode == 200) {
        ...
        if (redemData['status'] == "1") {
          ...
          Toast.show(
              redemData['message'], context, duration: Toast.LENGTH_SHORT);
        }
      }
    }).catchError((e) {
