...
//                                     ),
//                                     child: Image.network(
//                                       '${Uri.parse('${imageBaseUrl}${e.banner_image}')}',
//                                       fit: BoxFit.fill,
//                                     ),
//                                   ),
//                                 ),
    ...
    http.get(url).then((value) {
      if (value.statusCode == 200) {
        ...
        if (jsonData['status'] == "1") {
          ...
          List<PharmaBanner> tagObjs = tagObjsJson
              .map((tagJson) => PharmaBanner.fromJson(tagJson))
              .toList();
