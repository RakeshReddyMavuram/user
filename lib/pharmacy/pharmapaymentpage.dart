...
class PaymentPharmaPage extends StatefulWidget {
  ...
  PaymentPharmaPage(this.vendor_ids, this.order_id, this.cart_id, this.totalAmount, this.tagObjs);
...
class PaymentPharmaPageState extends State<PaymentPharmaPage> {
  ...
  PaymentPharmaPageState(this.order_id, this.cart_id, this.totalAmount, this.paymentVia);
  ...
  void hitNavigator(cart_id, payment_method, payment_status, order_id,
    ...
    http.post(url, body: {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(payment_method, payment_status, cart_id, rem_price,currency,"5");
      }));
    }).catchError((e) {
      setState(() {
        showDialogBox = false;
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return OrderPlaced(payment_method, payment_status, order_id, rem_price,currency,"5");
      }));
    });
  }
